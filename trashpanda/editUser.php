...
<link href="css/bootstrap.min.css" rel="stylesheet" type="text/css">
  ...
  <body >
	  ...
	  */
	  ...
	  ?>
            ...
            <h1 style="text-align:center; color:#FFF;">User</h1>
 ...
 $sql="SELECT  * from user where UID='$UID' limit 1 "	;
	...
	if($no>0){
		...
		<form action="updateUser.php" id="myForm" method="post">
	...
	while( $row=mysqli_fetch_assoc($result))	{
		...
		<tr>
			<td>Name</td>
		  <td> <input name="UID" type="hidden" value="<?php echo $row['UID']; ?>"  />
			  <input name="name" type="text" value="<?php echo $row['name']; ?>"  class="form-control"/></td>
		  </tr>	
			
			<tr>
			<td>Email</td>	
		  <td><input name="email" type="text" value="<?php echo $row['email']; ?>" class="form-control"/></td>
		  </tr>	
